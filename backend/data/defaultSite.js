export const defaultSite = {
  ...
  featuredWork: {
    ...
    moreWorkArrow: '→',
    moreWorkPageTitle: 'More work',
    moreWorkPageIntro: 'Every project — from product design to research and development.',
    ...
    projects: [
      ...
      },
      {
        ...
        tools: ['Figma', 'Design systems', 'Motion'],
      },
      {
        id: 'work-3',
        ...
        tools: ['Figma', 'Webflow', 'Art direction'],
      },
      {
        id: 'work-4',
      ...
      },
      {
        ...
        tools: ['Figma', 'After Effects', 'Web design'],
      },
      {
        id: 'work-6',
        slug: 'mobile-banking',
        ...
        tools: ['Interviews', 'Figma', 'Usability testing'],
      },
    ],
  },
  about: {
    ...
    paragraph1: "I'm Jana — a UX/UI designer who cares about how things feel as much as how they look. Every screen, flow, and interaction starts with real people and the problems they need solved.",
    paragraph2: 'Based in Cairo, I bridge research, interface design, and prototyping to build digital experiences that are clear, intentional, and human at every touchpoint.',
    stats: [
      { value: '5+', label: 'Years' },
      { value: '20+', label: 'Projects' },
      { value: 'Cairo', label: 'Based in' },
    ],
  ...
  disciplines: {
    ux: {
      ...
      label: 'Discipline 01',
      title: 'UX / UI',
      skills: ['Research', 'Wireframes', 'Prototypes', 'User testing', 'Design systems'],
    ...
    graphic: {
      ...
      label: 'Discipline 02',
      title: 'GRAPHIC',
      skills: ['Branding', 'Identity', 'Typography', 'Illustration', 'Print'],
  ...
  process: {
    ...
    title: 'How We Work',
    subtitle:
      'A proven process designed to transform complex workflows into scalable, user-centered products — efficiently and strategically.',
    steps: [
      {
        num: '01',
        title: 'Discovery & Audit',
        description: 'We analyze user needs, business goals, and existing product gaps.',
        icon: 'discovery',
      },
      {
        num: '02',
        title: 'Strategy Blueprint',
        description: 'We map user journeys and define a clear design direction aligned with outcomes.',
        icon: 'blueprint',
      },
      {
        num: '03',
        title: 'Design & Prototype',
        description: 'I design high-fidelity interfaces and interactive prototypes in Figma.',
        icon: 'build',
      },
      {
        num: '04',
        title: 'Testing & Optimization',
        description: 'Usability testing, feedback sessions, and continuous refinement.',
        icon: 'testing',
      },
      {
        num: '05',
        title: 'Delivery & Scaling',
        description: 'Developer handoff, launch support, and post-release optimization.',
        icon: 'deploy',
      },
    ],
  },
  ...
  caseStudies: {
    'wellness-app': {
      ...
      myRole: {
        ...
        pills: ['User research', 'Competitive analysis', 'User personas', 'Journey mapping', 'Wireframing', 'Prototyping', 'UI Design', 'Usability testing', 'Developer handoff'],
      },
      research: {
        sectionNumber: '03',
        ...
        highlight: 'actually',
        insights: [
          { number: '01', title: 'Rigidity repels', text: 'Users abandoned the app when missed days reset their progress. Streaks felt punishing rather than motivating — flexibility was non-negotiable.' },
          { number: '02', title: 'Noise erodes trust', text: 'Push notifications were the top uninstall trigger. People wanted fewer, better-timed nudges tied to goals they had actually set themselves.' },
          { number: '03', title: 'Progress must feel real', text: 'Participants needed visible proof that small actions counted. Abstract metrics meant nothing — tangible weekly summaries drove retention.' },
        ],
        persona: {
          name: 'Nour A.',
      ...
      designProcess: {
        ...
        highlight: 'sketch',
        stages: [
          { label: 'Low fidelity wireframe', variant: 'low' },
          { label: 'Mid fidelity', variant: 'mid' },
          { label: 'High fidelity', variant: 'high' },
        ],
      },
      finalDesign: {
        sectionNumber: '05',
        ...
        highlight: 'final',
        screens: [
          { label: 'Home screen', variant: 'home' },
          { label: 'Detail screen', variant: 'detail' },
          { label: 'Checkout screen', variant: 'checkout' },
        ],
      },
      outcomes: {
        sectionNumber: '06',
        ...
        highlight: 'proof',
        metrics: [
          { value: '89%', label: 'Task completion rate — up from 58% in baseline testing' },
          { value: '4.7', label: 'Average user satisfaction score out of 5' },
          { value: '-40%', label: 'Reduction in time on task across core flows' },
        ],
      },
    },
  },
